...
argument-hint: "[prd-file|feature-description] [--persona architect|frontend|backend|security|devops|...] [--strategy systematic|agile|mvp] [--output roadmap|tasks|detailed] [--estimate]"
wave-enabled: true
